...
-- Seed articles
INSERT INTO public.cline_article (title, description, content, tag, image, creator_id)
VALUES
    ('Le Caméléon Maître du Camouflage', 'Les caméléons changent de couleur pour se camoufler et communiquer.',
    'Les caméléons ne changent pas seulement de couleur pour se fondre dans leur environnement, mais aussi pour réguler leur température corporelle et communiquer avec d''autres caméléons.', 'Technologie', '/Public/images/creuve.jpeg', 1),

    ('Le Dauphin: Animal le Plus Intelligent', 'Les dauphins sont connus pour leur intelligence et leur sociabilité.',
    'Les dauphins ont un cerveau relativement grand par rapport à la taille de leur corps, et ils utilisent des sons pour naviguer et communiquer. Ils sont capables de résoudre des problèmes complexes et montrent des signes de conscience de soi.', 'Technologie', '/Public/images/festifeuilles.jpeg', 2),

    ('Le Pouvoir Mystérieux du Gecko', 'Le gecko a des capacités d''adhérence étonnantes.',
    'Grâce à des milliards de poils microscopiques appelés setae sur leurs orteils, les geckos peuvent accrocher à presque toutes les surfaces, même verticales, et se déplacer rapidement sans glisser.', 'Nourriture', '/Public/images/glassstaff.jpeg', 1),
    ...
    'Les abeilles communiquent entre elles en effectuant une danse en forme de huit pour indiquer l''emplacement des fleurs riches en pollen. Cette danse fournit des informations précises sur la distance et la direction des sources de nourriture.', 'Lifestyle', '/Public/images/jarodend.jpeg', 2),
    ...
    'Les pieuvres possèdent un cerveau complexe et sont capables de résoudre des énigmes et d''apprendre à travers l''expérience. Elles ont également la capacité de changer de couleur pour se camoufler et exprimer des émotions.', 'Sport', '/Public/images/kost.jpeg', 3),

    ('La Migration Époustouflante des Papillons Monarques', 'Les papillons monarques migrent sur des milliers de kilomètres.',
    'Chaque année, les papillons monarques parcourent plus de 4000 km pour migrer vers des climats plus chauds. Ce qui est fascinant, c''est que la génération qui entame le voyage n''est souvent pas celle qui le termine.', 'Couture', '/Public/images/mei.jpeg', 1),

    ('L''Incroyable Capacité de Régénération de l''Axolotl', 'L''axolotl peut régénérer des parties de son corps endommagées.',
    'L''axolotl est une créature aquatique capable de régénérer non seulement ses membres perdus, mais aussi des parties vitales de son cœur et de son cerveau. Les scientifiques étudient ce processus unique pour des applications médicales potentielles.', 'Bien-être', '/Public/images/soveliss.jpeg', 1),

    ('Les Éléphants: Gardiens de la Mémoire', 'Les éléphants ont une mémoire impressionnante.',
    'Les éléphants sont capables de se souvenir d''événements sur de longues périodes et peuvent reconnaître des individus humains et animaux même après des années de séparation. Leur mémoire est vitale pour la survie de leur troupeau.', 'Nature', '/Public/images/toblen.jpeg', 1);
